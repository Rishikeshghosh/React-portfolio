...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Rishikesh  <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                  fill="none"
        ...
        <p className='home__description'>Highly skilled and motivated Full Stack Developer with comprehensive knowledge in programming, developing, and maintaining web applications. Proficient in both front-end and back-end technologies, I have a track record of delivering robust, user-friendly, and responsive solutions. I am passionate about staying up-to-date with the latest technologies and applying best practices to create innovative software.
        </p> 
